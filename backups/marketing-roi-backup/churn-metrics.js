...
function startChurnUpdates(card) {
    // Initial values based on screenshot data
    const initialChurn = 7.2;
    const targetChurn = 5.0;
    const previousChurn = 6.8;
    ...
    function updateChurn() {
        ...
        // Calculate new churn with fluctuation
        currentChurn = Math.min(15, Math.max(0, currentChurn + fluctuation));
