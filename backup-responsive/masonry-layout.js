...
class MasonryLayout {
    constructor(containerSelector, itemSelector) {
        ...
        this.columnCount = 2; // Default to 2 columns max as per requirements
        this.columnWidth = 0;
        this.columns = [];
    ...
    updateLayout() {
        ...
        // Calculate how many columns can fit, but cap at 2 as per requirements
        let calculatedColumns = Math.floor(containerWidth / minColumnWidth);
        this.columnCount = Math.min(Math.max(1, calculatedColumns), 2);
